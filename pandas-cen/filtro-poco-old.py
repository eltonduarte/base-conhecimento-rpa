...
"""
caminho="@s6006vfs0601;prd_robotic_process_aa_002$;RPA_ROBOS;CENPES;CENPES01;Trabalho;Planilha_Planejamento_Contrato_RPA_22072021.xlsx"
...
nome_arquivo_email = "CTO_divergente_22072021"
...
def poco(lista):
    try:
        ...
        df_pocos.rename(columns={'Mês':'Mês|poco', "Ano":"Ano|poco","Valor Parcela":"Valor Parcela|poco"}, inplace=True)
        ...
        for i,j,k,d,p in zip(df_merge_ok["Mês|poco"], 
            df_merge_ok["Ano|poco"],
            df_merge_ok["Valor Parcela|poco"],
            df_merge_ok["Descrição"],
            df_merge_ok["Parcela"]):
            
            df_planejamento.loc[(df_planejamento["Descrição"]== d )&
            (df_planejamento["Parcela"]== p )&
            (df_planejamento["mes tratado"]== i )&
            (df_planejamento["Ano"]==j) & 
            (df_planejamento["multiplica"]==k),"Validacao Painel CTO"] = "OK"
